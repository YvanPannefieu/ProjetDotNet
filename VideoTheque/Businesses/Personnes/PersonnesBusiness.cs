...
namespace VideoTheque.Businesses.Personnes
{
    public class PersonnesBusiness : IPersonnesBusiness
    {
        ...
        public PersonneDto InsertPersonne(PersonneDto personne)
        {
            ...
            {
                throw new InternalErrorException($"Erreur lors de l'insertion de {personne.FirstName} {personne.LastName}");
            }
        ...
        public void UpdatePersonne(int id, PersonneDto personne)
        {
            ...
            {
                throw new InternalErrorException($"Erreur lors de la modification de {personne.FirstName} {personne.LastName}");
            }
        }
        ...
        public void DeletePersonne(int id)
        {
            ...
            {
                throw new InternalErrorException($"Erreur lors de la suppression de {id}");
            }
        }
    }
}
